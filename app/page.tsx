...
export default function Page() {
  const darkBgStyle = 'min-h-screen flex flex-col items-center bg-bg-dark';
  const lightBgStyle = 'min-h-screen flex flex-col items-center';
  ...
  return (
    <div className={`${lightTheme ? lightBgStyle : darkBgStyle}`}>
